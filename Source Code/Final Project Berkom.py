...
total_harga = 0
kustomisasi_ukuran = [0] * max_pesanan
kustomisasi = ["0"] * max_pesanan
# =================================
...
def cek_stok(list_barang, stok_barang, harga_barang, jenis_menu):
    for i in range(jenis_menu):
        ...
        if stok_tersedia:
            ...
            stok = "Habis"
        print(f"{i + 1}. {list_barang[i]}" + " " * (
                    40 - len(list_barang[i] + f"{i + 1}")) + f"Rp. {harga_barang[i]}     -{stok}({stok_barang[i]})-")


# Fungsi yang mencatat dan mengecek pesanan yang dipilih dan mengembalikan indeks_pesanan yang sudah diupdate
def mengecek_pesanan(list_barang, harga_barang, indeks_pesanan, pilihan, banyak, pesanan_nama, pesanan_jumlah,
                     pesanan_harga, pesanan_total):
...
def do_order(list_barang, stok_barang, harga_barang, indeks_pesanan, choice_jenis, total_harga):
    ...
    indeks_pesanan = mengecek_pesanan(list_barang, harga_barang, indeks_pesanan, pilihan, banyak, pesanan_nama,
                                      pesanan_jumlah, pesanan_harga, pesanan_total)
    ...
    if choice_jenis == 4:
        ...
        for i in range(banyak):
            ...
            while pilih_ukuran_gelas == False:
                ...
                if ukuran_gelas == "S":
                    total_harga += 0
                    kustomisasi_ukuran[indeks_pesanan] += 0
                    pilih_ukuran_gelas = True
                elif ukuran_gelas == "M":
                    total_harga += 4000
                    kustomisasi_ukuran[indeks_pesanan] += 4000
                    pilih_ukuran_gelas = True
                elif ukuran_gelas == "L":
                    total_harga += 5000
                    kustomisasi_ukuran[indeks_pesanan] += 5000
                    pilih_ukuran_gelas = True

        #Memilih minuman panas atau dingin
        pilih_kustomisasi = False
        while pilih_kustomisasi == False:
            if pilihan in {1, 3, 7}:
                pilihan_kustomisasi = input("Pilih minuman kamu mau dingin(C) atau panas(H)? (H / C):")
                print()
                if pilihan_kustomisasi in {"H", "C"}:
                    kustomisasi[indeks_pesanan] = pilihan_kustomisasi
                    pilih_kustomisasi = True
            pilih_kustomisasi = True
        ...
        if (choice_jenis > 0 and choice_jenis <= 8):
            ...
            if (choice_jenis == 1):
                ...
                while pesan_lagi:
                    ...
                    indeks_dan_totalharga = do_order(list_Sushi, stok_sushi, harga_Sushi, indeks_pesanan, choice_jenis,
                                                     total_harga)
                ...
                while pesan_lagi:
                    ...
                    # Fungsi do_order() akan dijalankan dengan beberapa algoritma di dalamnya dan mengembalikan "indeks_pesanan" yang telah diupdate
                    indeks_dan_totalharga = do_order(list_Ramen, stok_ramen, harga_Ramen, indeks_pesanan, choice_jenis,
                                                     total_harga)
                ...
                while pesan_lagi:
                    ...
                    # Fungsi do_order() akan dijalankan dengan beberapa algoritma di dalamnya dan mengembalikan "indeks_pesanan" yang telah diupdate
                    indeks_dan_totalharga = do_order(list_Ricebowl, stok_ricebowl, harga_Ricebowl, indeks_pesanan,
                                                     choice_jenis, total_harga)
                ...
                while pesan_lagi:
                    ...
                    # Fungsi do_order() akan dijalankan dengan beberapa algoritma di dalamnya dan mengembalikan "indeks_pesanan" yang telah diupdate
                    indeks_dan_totalharga = do_order(list_Minuman, stok_minuman, harga_Minuman, indeks_pesanan,
                                                     choice_jenis, total_harga)
                ...
                while pesan_lagi:
                    ...
                    # Fungsi do_order() akan dijalankan dengan beberapa algoritma di dalamnya dan mengembalikan "indeks_pesanan" yang telah diupdate
                    indeks_dan_totalharga = do_order(list_PaketWibu, stok_PaketWibu, harga_PaketWibu, indeks_pesanan,
                                                     choice_jenis, total_harga)
                ...
                while pesan_lagi:
                    ...
                    # Fungsi do_order() akan dijalankan dengan beberapa algoritma di dalamnya dan mengembalikan "indeks_pesanan" yang telah diupdate
                    indeks_dan_totalharga = do_order(list_Appetizer, stok_Appetizer, harga_Appetizer, indeks_pesanan,
                                                     choice_jenis, total_harga)
                                    ...
                                    if (yakin_checkout == "y"):
                                        ...
                                        if choice_bayar != 4:  # Selain QRIS
                                            ...
                                            for i in range(indeks_pesanan):
                                                ...
                                                if kustomisasi_ukuran[i + 1] != 0:
                                                    print(
                                                        f"Kustomsasi: {pesanan_nama[i]} x { pesanan_jumlah[i]} : Rp.{kustomisasi_ukuran[i]}")
