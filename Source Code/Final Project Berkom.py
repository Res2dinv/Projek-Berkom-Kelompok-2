                                    ...
                                    if item_kurang == pesanan_nama[i]:
                                        if pesanan_jumlah[i] > 0:
                                            ...
                                            if pesanan_jumlah[i] <= 0:
                                                ...
                                                indeks_pesanan -= 1
                                if pesanan_jumlah[pilihan_kurang - 1] !=0:
                                    kustomisasi[pilihan_kurang-1] = input("Masukkan keterangan untuk pesanan: ")
                                    ...
                                    if (yakin_checkout == "y"):
                                        ...
                                        if choice_bayar != 4:  # Selain QRIS
                                            ...
                                            while True:  # QRIS
                                                ...
                                                print("")
                                                print("Tip : Rp", tip)
                                                print(f"Total Harga: Rp{total_harga+tip}                              ")
                                                print(f"Pembayaran: {opsi_pembayaran[choice_bayar - 1]}")
